(function (root, factory) {
    ...
    } else if (typeof root["J"]["templates"] === 'undefined' || root["J"]["templates"] !== Object(root["J"]["templates"])) {
        throw new Error('templatizer: window["J"]["templates"] does not exist or is not an object');
    } else {
        root["J"]["templates"].templatizer = factory();
    }
}(this, function () {
    ...
    var templatizer = {};
    templatizer["patterns"] = {};

    // _patterns.jade compiled template
    templatizer["_patterns"] = function tmpl__patterns(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        var locals_for_with = locals || {};
        (function(patternsArr, undefined) {
            (function() {
                var $obj = patternsArr;
                if ("number" == typeof $obj.length) {
                    for (var $index = 0, $l = $obj.length; $index < $l; $index++) {
                        var pattern = $obj[$index];
                        buf.push("<p>" + jade.escape(null == (jade_interp = pattern.title) ? "" : jade_interp) + "</p>");
                    }
                } else {
                    var $l = 0;
        ...
        }).call(this, "patternsArr" in locals_for_with ? locals_for_with.patternsArr : typeof patternsArr !== "undefined" ? patternsArr : undefined, "undefined" in locals_for_with ? locals_for_with.undefined : typeof undefined !== "undefined" ? undefined : undefined);
        return buf.join("");
    };

    // index.jade compiled template
    templatizer["index"] = function tmpl_index() {
        return '<!DOCTYPE html><html lang="en"><head><title>Jayda</title><meta name="viewport" content="width=device-width, initial-scale=1"><meta http-equiv="Content-Type" content="text/html;charset=utf-8"><link rel="stylesheet" type="text/css" href="../css/main.css"></head><body><div class="container"><h1>Jayda</h1><div class="side-nav-wrap"></div><div class="patterns-wrap"></div></div><script type="text/javascript" src="../../node_modules/jade/jade.js"></script><script type="text/javascript" src="../bower_components/jQuery/dist/jquery.min.js"></script><script type="text/javascript" src="../bower_components/underscore/underscore-min.js"></script><script type="text/javascript" src="../js/jayda.js"></script><script type="text/javascript" src="../dist/compiled_patterns.js"></script><script type="text/javascript" src="../dist/compiled_jayda_templates.js"></script><script type="text/javascript" src="../js/app.js"></script></body></html>';
    };
